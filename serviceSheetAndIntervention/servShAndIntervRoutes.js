...
routes.get('/interv/all',[middleware.checkToken,middleware.verifyToken,middleware.checkRoleOperator],IntervActions.getOnlyAllInterv);
...
routes.get('/serv-sh/all',[middleware.checkToken,middleware.verifyToken,middleware.checkRoleOperator],servShActions.getOnlyAllServSh);
